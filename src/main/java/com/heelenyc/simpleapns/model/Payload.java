...
public class Payload {
	...
	private Map<String, Object> apnsExtraField ;
    ...
    private static int MAX_ALERBODY_LENGTH = 120;
	...
	public void addApnsExtraField(String key, Object obj) {
		if (apnsExtraField == null) {
		    apnsExtraField = new HashMap<String, Object>();
		}
		apnsExtraField.put(key, obj);
	}
	...
	public Map<String, Object> getApnsExtraField() {
        return apnsExtraField;
    }
	...
	public void setApnsExtraField(Map<String, Object> apnsExtraField) {
        this.apnsExtraField = apnsExtraField;
    }
	...
	protected String ensureTextLength(String alert, int maxCount) {
	...
	public String toString() {
		...
		if (getAlert() != null) {
			...
			if (getAlertBody() != null || getAlertLocKey() != null) {
				...
				putIntoJson("body", ensureTextLength(getAlertBody(),MAX_ALERBODY_LENGTH ), alertObj);
		...
		if (apnsExtraField != null && apnsExtraField.size() > 0) {
            for(Entry<String, Object> entry : apnsExtraField.entrySet()){
                apsObj.put(entry.getKey(), entry.getValue());
            }
        }
    ...
    public static void main(String[] args) {
        ...
        payload.addApnsExtraField("test", "test");
